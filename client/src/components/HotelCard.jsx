        ...
        <div className="mt-4 px-1">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="flex items-center gap-2 mt-2 text-gray-500">
                ...
                <p className="text-sm">{rooms.hotel.address}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mt-5">
            <div className="flex items-end gap-1">
              ...
              <p className="text-sm text-gray-500 mb-1">/ night</p>
            </div>

            <button className="bg-black text-white px-5 py-2.5 rounded-xl text-sm font-medium shadow-lg hover:scale-105 hover:bg-gray-900 transition-all duration-300">
              Book Now
            </button>
          </div>
        </div>
